...
import { LayoutDashboard, Receipt, Store, Settings, LogOut, Wallet, Moon, Sun, Menu, X, Repeat, Target, Globe, PiggyBank, Landmark } from 'lucide-react'
...
export default function NavBar() {
  ...
  const navItems = [
    ...
    { to: '/incomes', label: t('nav.incomes'), icon: PiggyBank },
